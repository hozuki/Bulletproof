...
import {EventBase} from "../../../../../lib/glantern/src/gl/glantern/EventBase";
...
export class Html5VideoPlayer extends VideoPlayerBase {
    ...
    constructor(videoElement:HTMLVideoElement = null) {
        super();
        if (!GLUtil.ptr(videoElement) || !(videoElement instanceof HTMLVideoElement)) {
