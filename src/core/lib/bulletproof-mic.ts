...
export module bulletproof.mic {
    ...
    export class Color {
        ...
        public static fromNumber(value:number, format:string = ColorFormat.ARGB):Color {
        ...
        public toNumber(format:string = ColorFormat.ARGB):number {
            var s = 0;
            switch (format) {
                case ColorFormat.ARGB:
        ...
        public toNumberString(format:string = ColorFormat.ARGB):string {
...
export module bulletproof.mic.util {
    ...
    export function alphaBlend(sR:number, sG:number, sB:number, sA:number,
